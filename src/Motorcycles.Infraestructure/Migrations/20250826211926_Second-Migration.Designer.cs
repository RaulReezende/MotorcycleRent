...
namespace Motorcycles.Infraestructure.Migrations
{
    ...
    [Migration("20250826211926_Second-Migration")]
            ...
            modelBuilder.Entity("Motorcycles.Domain.Entities.Rental", b =>
                {
                    ...
                    b.HasOne("Motorcycles.Domain.Entities.Motorcycle", null)
                        .WithOne("Rental")
                        .HasForeignKey("Motorcycles.Domain.Entities.Rental", "MotorcycleId1");
